...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFlowerData = new FlowerData("Masjidil Haram", getString(R.string.description_flower_rose),
                R.drawable.masjidil_haram);
        mFlowerList.add(mFlowerData);
        mFlowerData = new FlowerData("Masjid Nabawi", getString(R.string.description_flower_rose),
                R.drawable.masjid_nabawi);
        mFlowerList.add(mFlowerData);
        mFlowerData = new FlowerData("Hagia Sophia", getString(R.string.description_flower_rose),
                R.drawable.hagia_sophia);
        mFlowerList.add(mFlowerData);
        mFlowerData = new FlowerData("Colosseum", getString(R.string.description_flower_rose),
