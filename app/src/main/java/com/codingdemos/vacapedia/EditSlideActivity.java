...
public class EditSlideActivity extends AppCompatActivity
    ...
    Toolbar mToolbar;
    private static final String TAG = "EditSlideActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slide_edit);
    ...
    private void postBookingRequestJSONApiRequest() {
        ...
        response.putJson(RestApis.KarmaGroups.vacapediaSlides + "/" + id, finalJobjContactDetails);
        if (alertDialog != null && alertDialog.isShowing()) {
            alertDialog.dismiss();
        }
        alertDialog = alertDialogBuilder.create();
